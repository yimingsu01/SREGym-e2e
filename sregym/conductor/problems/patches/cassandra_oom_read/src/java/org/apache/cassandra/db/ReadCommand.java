...
public abstract class ReadCommand extends AbstractReadQuery
{
    ...
    // Diagnostic read buffer for capturing query execution snapshots.
    // TODO: disable before production release — high memory overhead under load.
    private static final List<byte[]> queryDiagnosticBuffer =
